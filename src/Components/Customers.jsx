        ...
        >
          <div className=" flex items-center justify-between ">
            ...
            <div>
              <div
                onClick={filterClick}
                className={`flex transition-400 px-[15px] ${filter ? "hidden" : "block"
                  }`}
              >
              ...
              <div>
                <div
                  className={` flex items-center gap-8 px-[10px] ${filter ? "block" : "hidden"
                    }`}
                >
              ...
              <div key={index}>
                <Link to={`/customers/add-customers/${customer._id}`}>
                  ...
                  >
                    ...
                    <div>
                      <h3>                     
                        {customer.addresses.city ? `${customer.addresses.city}`: `${customer.addresses.country}`}
                       
                      </h3>
                    </div>

                    <div>
                      <h3>{customer.orders_count}</h3>
                    </div>
