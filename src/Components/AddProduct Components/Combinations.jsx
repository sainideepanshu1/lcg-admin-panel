...
export default function Combinations() {
  ...
  const filterVariants = (option1Value) =>
    product.variants.filter((variant) => variant.option1 === option1Value);
                          ...
                          <div className="w-1/2 flex items-center gap-3">
                            ...
                            >
                              {Object.keys(variant)
                                .filter(
                                  (key) =>
                                    key.includes("option") && key !== "option1"
                                )
                                .map((key, index, array) => (
                                  <span key={index}>
                                    {variant[key]}
          ...
          <>
            {product.variants.map((variant, index) => (
              <div key={index} className="w-full">
                {/* <div className="flex p-3">
                  <div className="w-1/2">
                    <button className="w-1/2 text-left">
                      {variant.option1}
                    </button>
                  </div>
                  <div className="flex w-1/2 gap-3">
                    <div>
                      <input
                        type="text"
                        className="pl-3 rounded-lg border w-1/2 text-[13px]"
                      />
                    </div>
                    <div>
                      <input
                        type="text"
                        className="pl-3 rounded-lg w-1/2 text-[13px]"
                        disabled
                        placeholder="0"
                      />
                    </div>
